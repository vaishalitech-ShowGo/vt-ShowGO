    ...
    <>
      <div className="bg-black text-white min-h-screen flex flex-col items-center px-4 md:px-8 lg:px-20 py-10">
        ...
        <div className=" text-center max-w-[1040px] w-full ">
          ...
          <p className="text-gray-400 w-7/8 text-[14px] relative left-20 leading-relaxed mb-8">
        ...
        {/* Attendees Section */}
        <div className="max-w-[1180px] w-full text-center mt-12">
        ...
        <div className="max-w-[1190px] w-full text-center mt-12">
