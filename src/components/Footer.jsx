    ...
    <div className="w-full min-h-[400px] bg-black flex flex-col items-center justify-center">
      ...
      <div className="container mx-auto flex flex-wrap justify-center items-start gap-6 pt-10 px-6 md:px-12 lg:px-16">
        ...
        <div className="flex flex-col gap-3 w-full sm:w-[45%] md:w-[30%] lg:w-[20%] min-w-[160px] text-left">
          <Link to="/contact" className="text-lg font-semibold hover:underline" onClick={() => window.scrollTo(0, 0)}>
            Contact Us
          </Link>
          <p className="flex items-center gap-2">
            📧 <a href="mailto:info@musicfest.com" className="hover:underline">info@musicfest.com</a>
          </p>
          <p className="flex items-center gap-2">
        ...
        <div className="flex flex-col gap-2 w-full sm:w-[45%] md:w-[30%] lg:w-[16%] min-w-[160px] text-left">
          ...
          <a href="/join-community" className="hover:underline">Join Community</a>
        ...
        <div className="flex flex-col gap-2 w-full sm:w-[45%] md:w-[30%] lg:w-[10%] min-w-[160px] text-left">
          ...
          <Link to="/account-delete" className="hover:underline" onClick={() => window.scrollTo(0, 0)}>
        ...
        <div className="flex flex-col gap-4 w-full sm:w-[45%] md:w-[60%] lg:w-[20%] text-left">
          ...
          <div className="flex flex-wrap gap-3 justify-start">
            <input type="email" placeholder="Enter your email" className="bg-[#27272A] text-white rounded-[8px] outline-none w-full px-2 py-1" />
            <button className="bg-white text-black rounded-[8px] cursor-pointer text-[15px] px-3 py-2">Subscribe</button>
          </div>
        </div>
      </div>
